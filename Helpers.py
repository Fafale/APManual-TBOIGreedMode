...
def check_character_name(char_name, target_name):
    if "Tainted" in char_name:
        return (char_name in target_name)
    else:
        return ((char_name in target_name) and not ("Tainted" in target_name))